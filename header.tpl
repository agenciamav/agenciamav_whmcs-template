<!DOCTYPE html>
	<html lang="en">
		<head>
			...
			<!-- Main Stylesheet -->
			<link href="templates/{$template}/assets/whmcs/css/style.css" rel="stylesheet">
		...
		<body>
			...
			<!-- <a href="{$systemurl}" title="{$companyname}">
			</a> -->

			<header id="whmcs-header" class="navbar navbar-inverse navbar-fixed-top">
				<div class="container">
					<div class="navbar-header">
						...
						<nav class="collapse navbar-collapse" id="navbar-collapse-0" role="navigation">
							<ul class="nav navbar-nav navbar-inverse">
								<li class="active">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown" title="">
										...
										<img src="templates/{$template}/assets/whmcs/img/logo_white_small.png" alt="{$companyname}" id="navbar-logo" class="img-responsive pull-left">
...
{if $loggedin}
						...
						<ul class="nav navbar-nav navbar-right">
							<li class="dropdown">
								<a href="#" class="dropdown-toggle navbar-gravatar" data-toggle="dropdown">
									<span class="fa fa-angle-down"></span>
									Olá, {$clientsdetails.firstname} 
									<img src="//www.gravatar.com/avatar/{$clientsdetails.email|md5}?s=36&amp;d=mm" alt="Profile Photo" class="img-circle"> 
								</a>
										...
										<div class="panel panel-default">
											<div class="panel-body">
												<div class="thumbnail pull-left">
													<img src="//www.gravatar.com/avatar/{$clientsdetails.email|md5}?s=50&amp;d=mm" alt="Profile Photo" class="">												
												</div>
											  	<strong class="h1 text-uppercase">
											  		<small>Olá, </small> {$clientsdetails.firstname} {$clientsdetails.lastname}
											  	</strong>
											</div>
										</div>
									...
									<div class="col-sm-3 col-md-3 col-lg-3">
										<ul class="">
											{if $smarty.session.adminid}
												<li>
													<a href="admin/clientssummary.php?userid={$smarty.session.uid}&amp;return=1">Return to Admin Area</a>
												</li>
											{/if}
...
{else}
						...
						<ul class="nav navbar-nav navbar-right">
							<li class="dropdown">
								<a href="#" class="dropdown-toggle navbar-gravatar" data-toggle="dropdown">
									<span class="fa fa-angle-down"></span>
									<img src="//www.gravatar.com/avatar/?s=36&amp;d=mm" alt="Profile Photo" class="img-circle">
								</a>
								<ul class="dropdown-menu">
